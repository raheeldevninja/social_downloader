...
class DownloadTwitterMainContent extends StatefulWidget {
  const DownloadTwitterMainContent({super.key});

  @override
  State<DownloadTwitterMainContent> createState() => _DownloadTwitterMainContentState();
}

class _DownloadTwitterMainContentState extends State<DownloadTwitterMainContent> {
  @override
