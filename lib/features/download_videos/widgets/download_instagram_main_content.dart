...
class DownloadInstagramMainContent extends StatefulWidget {
  const DownloadInstagramMainContent({super.key});

  @override
  State<DownloadInstagramMainContent> createState() => _DownloadInstagramMainContentState();
}

class _DownloadInstagramMainContentState extends State<DownloadInstagramMainContent> {
  @override
